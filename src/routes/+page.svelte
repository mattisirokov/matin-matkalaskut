...
<div
	class="relative flex min-h-screen items-center justify-center bg-[url('/background.jpg')] bg-cover bg-center bg-no-repeat p-8 text-white before:absolute before:inset-0 before:bg-black before:opacity-65"
>
	<div class="relative w-full max-w-4xl">
		<div class="mb-12 text-center">
			<h1 class="mb-4 text-5xl font-bold">Matti's work trip calculator</h1>
		</div>
